...
import { useConsumptionDetail } from "~/rest/apiHooks/reports/useReports";
...
const Reports = () => {
  ...
  const { data, isLoading, error, isError } = useConsumptionDetail(
    currentMonth,
    currentYear,
    getAccountType(),
    {
        ...
        {consumptionData.length > 0 && (
          ...
          >
            ...
            <Grid item xs={2.4} paddingLeft={0.5}>
              <Tooltip title={successTransactionCount}>
                <Typography variant="h2" display="inline">
                  {successTransactionCount}
                </Typography>
              </Tooltip>
            ...
            <Grid item xs={2.4} paddingLeft={1}>
              <Tooltip title={failureTransactionCount}>
                <Typography variant="h2" display="inline">
                  {failureTransactionCount}
                </Typography>
              </Tooltip>
      ...
      {isShowUnAuthView ? (
        ...
        <Fragment>
          <FormProvider {...methods}>
            <ContainerLayout breadCrumbs={[labels.consumptionDetails]}>
              <Grid
                container
                item
                direction="row"
